...
class PatientInfoController:
    ...
    def setPatientInfo(self):
        ...
        if patient:
            ...
            self.view.label_patient_dob.setText("Date fo birth: " + patient_info["date_of_birth"])  # Correct field usage
            ...
            self.view.label_patient_allergy.setText("Analgesics allergy: " + ("Yes" if patient_info["analgesics_allergy"] else "No"))
